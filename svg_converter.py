...
# how many steps to interpolate between each bezier control point
ip_steps = 8
# scale the svg size by this
scalingFactor = 10
    ...
    for path in paths:
        for segment in path:
            if isinstance(segment, svgpathtools.Line):
                ...
                segment, (svgpathtools.CubicBezier, svgpathtools.QuadraticBezier)
            ):
